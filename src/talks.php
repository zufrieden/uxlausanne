...
$app->talks = array(
    ...
    'simon_raess' => array(
        ...
        'kind' => $app->talk_kinds['talk'],
        'title' => "Mind the gap",
        'teaser' => "The difference between crappy and great User Experiences",
        'description' => "<p>I’m utterly fascinated by the enormous gap of quality in UX design: Anything from the most frustrating to the most delightful user experiences can be found out there.</p><P>Of course, nobody ever wants to create something bad by intention. Yet, even the worst possible user interfaces are deliberately designed by somebody. At the same time, some designers repeatedly create brilliant results in a relaxed, even casual manner.</P><P>In my talk I’d like to discuss the nature of this gap. To do this, I will first share the stories of some truly influential designers in our field. We will then explore the defining factors of their success and try to learn something from them.</P><P>Spoiler alert: It takes a lot more than just talent and hard work…</P>",
        'location' => "Salle 2",   
    ),
    ...
    'opening' => array(
        ...
        'teaser' => "<p>If you are already in town, we are welcoming you at the Café de grancy to share some drinks. Come there to discover the speakers and your fellow attendees.</p><p> We will also distribute your badge from 18:00 to 19:45.</p>",
        'description' => "",
        'sponsor' => "",
        'speaker' => "",   
        'location' => "Café de Grancy, Av. du Rond-Point 1, 1006 Lausanne.",   
    ),
    'lunch' => array(
        'slug' => 'lunch',
        'position' => 0,
    ...
    'closing' => array(
        ...
        'kind' => $app->talk_kinds['other'],
        'title' => "Closing party",
        'teaser' => "<p>The party starts at 19:00 and will run until you get tired</p>",
        'description' => "",
        'sponsor' => $app->sponsors_major['liip'],
        'speaker' => "",   
        'location' => "Bourg Plage, sous le pont Bessière.",   
    ),
    'breakfast' => array(
        'slug' => 'breakfast',
        'position' => 0,
        ...
        'kind' => $app->talk_kinds['other'],
        'title' => "Breakfast ",
        'teaser' => "<p>The venue will open at 8am.</p><p>A small breakfast with coffee will be served before the first presentation.</p><p>During this period, you can collect your badge at the entrance hall.</p>" ,
        'description' => "",
        'sponsor' => "",
        'speaker' => "",
        'location' => "Le Foyer",   
    ...
    'thursdaydance' => array(
        ...
        'kind' => $app->talk_kinds['other'],
        'title' => "Twerk",
        'teaser' => "Discover the show Twerk. A modern dance happening in the venue of l'arsenic." ,
        'description' => "",
        'sponsor' => "",
        'speaker' => "",
        'location' => "Salle 1",   
