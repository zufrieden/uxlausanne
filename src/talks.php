...
$app->talks = array(
    ...
    'brigit_geiberger_and_peter_boersma_workshop' => array(
        ...
        'description' => "People in the field of User Experience are taught that having empathy for the end-user is the holy grail. We believe that, by studying the way your fellow project team members work, what their needs are, and what & how they deliver, you can develop another type of empathy, one that may prove to be more important for business success and results in a delightful work environment. <br/>In the first half of this workshop, we want to walk you through the design process and the people you will meet on the way, mostly from outside of your design team's environment. We will show how your skills and contributions allow you to influence their work and, indirectly, the resulting end-user experience.<br/>Peter will explain that documenting your organization's design process allows you to sell your work better, to train new team members easier, to maintain a consistent vocabulary for your team, and to measure and improve your team’s effectiveness.<br/>Activities in this part will include sketching org charts and design process diagrams to identify the relevant people to influence, as well as specifying input and deliverables that will help your organization to identify, design and build successful user experiences. The end-result is a plan to improve your process.<br/>In the second half, we will focus on how to successfully communicate your contributions to different stakeholders during the design process.Birgit will explain the concept of communication styles, and show you how to identify your own style and that of co-workers. She will teach you how to adapt your own style to others to ensure you will be heard during a project, and help you to overcome conflicts.Activities in this part will include discussing a typical work-related communication problem; finding a solution and gaining a common ground; a self evaluation exercise; applying the communication styles on the earlier introduced problem and finding more effective ways to solve this (and other) challenges.<br/>We believe that by paying attention to these two aspects, process and people, you will develop that other kind of empathy, the kind that makes you a better participant in the design process, helps you communicate your designs better, while enjoying your work more. It makes you do the right thing.<h5>Who is this workshop for?</h5>User Experience designers, of course, as well as people in the roles around the design process: from user researchers, via project managers and front-end developers, to account managers and heads of design departments.The focus of this workshop is on learning how to determine the best design process for your team and the importance of communication that is needed to successfully work within a team environment.<h5>What will you learn?</h5><ul><li> Understand the roles involved in the design process</li><li>Document your work process</li><li>Define your team's deliverables</li><li>Communicate your process</li><li>Communication style theories</li><li>Understand your own communication style and that of co-workers</li><li>Methods to flex your style to others</li><li>Become aware of - and overcome - communication pain-points in the design process</li></ul><h5>Prior knowledge from participants:</h5>It helps if participants have thought about their design process and the way they communicate before but, more importantly, they should have some experience designing in different teams and for different internal or external clients.",
    ),
    ...
    'janina_woods' => array(
        ...
        'description' => "In this talk, Janina reflects on the latest evolution of the world of Virtual Reality by showcasing her current concrete work and reflects on how those new devices imply new paradigms of UI and UX - both in games, and in a broader spectrums of fields. <br />She will then describe a near-future world where our Classic interface with the world will be replaced by an virtual Augmented Reality one and explore usages of Virtual reality featured in marketing and game contexts",
    ),
    ...
    'nicolas_nova' => array(
        ...
        'teaser' => "Undertand how to make your design research actionnable",
    ...
    'oliver_reichenstein' => array(
        ...
        'description' => "Designers hold a key position in dealing with ever increasing data pollution. We are mostly focussed on speeding things up, on making sharing easier, faster, more accessible. But speed, usability, accessibility are not the main issue anymore. The main issues are not technological, they are structural, processual. <br/> What we lack is clarity, correctness, depth, time. Are there conter-techniques we can employ to turn data into information, information into knowledge, knowledge into wisdom?",
    )
